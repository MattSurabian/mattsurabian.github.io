...
description: "An outline of my dot-files project and how it can help to backup hidden configuration files"
category: Web Development
tags: [crypto, productivity, backup, web development, Github]
---
{% include JB/setup %}
